...
export default function OfferCard({ offer }: OfferProps) {
  ...
  const handleOfferSelection = useCallback(async () => {
    ...
    try {
      ...
      const selected_extra_features = selectedFeatures.map((index) => offer.extra_features[index].id)
      ...
      const orderData = {
        ...
        vehicule: {
          ...
          vehicule_use_purpose: vehicule_use_purpose ? vehicule_use_purpose : "personal",
